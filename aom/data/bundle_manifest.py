...
def validate_bundle_manifest(
    ...
    *,
    ...
    role_to_path: dict[str, str | None] = {
        "disamb": None if disamb_path is None else str(disamb_path),
        "cf": None if cf_path is None else str(cf_path),
        "coh": None if coh_path is None else str(coh_path),
    }
